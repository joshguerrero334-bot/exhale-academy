...
import SlideDeckViewer from "../../../components/cheat-sheets/SlideDeckViewer";
import { asthmaCheatSheetDeck } from "../../../lib/cheat-sheets";
import { headingFont } from "../../../lib/fonts";
import { createClient } from "../../../lib/supabase/server";

export const metadata: Metadata = {
  title: "Asthma Cheat Sheet for Respiratory Therapy Students",
  description:
    "Asthma visual cheat sheet for TMC and CSE prep covering symptoms, triggers, diagnostics, interventions, and board exam reminders.",
};

export default async function AsthmaCheatSheetPage() {
  ...
  if (userError || !user) {
    redirect("/login?next=%2Fcheat-sheets%2Fasthma");
  }
    ...
    <main className="min-h-screen bg-background text-charcoal">
      <div className="mx-auto w-full max-w-6xl space-y-6 px-4 py-8 sm:px-6 lg:px-8">
        <section className="rounded-2xl border border-graysoft/30 bg-white p-6 shadow-sm sm:p-8">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-primary">Respiratory Disease Cheat Sheet</p>
          <div className="mt-3 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-3xl">
              <h1 className={`${headingFont} text-3xl font-semibold text-charcoal sm:text-4xl`}>
                Asthma Visual Cheat Sheet
              </h1>
            ...
            <div className="flex flex-wrap gap-3">
              <Link href="/cheat-sheets" className="btn-secondary">
        ...
        <SlideDeckViewer slides={asthmaCheatSheetDeck.slides} />
