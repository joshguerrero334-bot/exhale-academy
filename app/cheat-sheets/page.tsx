...
import { cheatSheetDecks } from "../../lib/cheat-sheets";

export const metadata: Metadata = {
  title: "Visual Cheat Sheets for Respiratory Therapy Students",
  description:
    "Visual respiratory therapy cheat sheets and slide-based study guides for TMC and CSE board exam prep.",
};
...
export default async function CheatSheetsPage() {
  ...
  if (userError || !user) {
    redirect("/login?next=%2Fcheat-sheets");
  }
    ...
    <main className="min-h-screen bg-background text-charcoal">
      <div className="mx-auto w-full max-w-6xl space-y-8 px-4 py-8 sm:px-6 lg:px-8">
        <section className="rounded-2xl border border-graysoft/30 bg-white p-6 shadow-sm sm:p-8">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-primary">Visual Cheat Sheets</p>
