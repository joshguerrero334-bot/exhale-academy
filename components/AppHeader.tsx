...
const menuPanelClass =
  "absolute right-0 mt-2 w-64 rounded-xl border border-graysoft/30 bg-white p-2 shadow-lg";
const menuLinkClass =
  "block rounded-md px-3 py-2 text-sm text-charcoal hover:bg-primary/5";
...
export default async function AppHeader() {
  ...
  const slideshowsHref = user ? "/slideshows" : "/login?next=%2Fslideshows";
          ...
          {user ? (
            <>
              <details className="relative">
                <summary className={`${secondaryBtnClass} list-none cursor-pointer`}>
                  Study Menu
                </summary>
                <div className={menuPanelClass}>
                  ...
                  <Link href={slideshowsHref} className={menuLinkClass}>
                    Slideshows
                  </Link>
                  <Link href={cseHref} className={menuLinkClass}>
                    CSE Practice
                  </Link>
                  <Link href={tmcHref} className={menuLinkClass}>
                    TMC Practice
                  </Link>
                  <Link href={feedbackHref} className={menuLinkClass}>
